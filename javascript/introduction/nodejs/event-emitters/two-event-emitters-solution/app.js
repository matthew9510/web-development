...
logger.log("Some message") // note the above listener will not be triggered because inside the logger.js file, we are working with two different event emitters in both files
